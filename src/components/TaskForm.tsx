...
export const TaskForm = () => {
  ...
  const handleSubmit = (e: FormEvent<HTMLFormElement>) => { 
    ...
    if (editedTask.taskId === '') createTaskMutation.mutate({ title: editedTask.title, body: editedTask.body })
    else { 
  ...
  return (
    <form onSubmit={handleSubmit} className="mb-5 text-center">
      ...
      <button className=' rounded bg-blue-600 py-1 px-3 text-white hover:bg-indigo-700 focus:outline-none'>
